 ...
 * @author vPalomo
 */
public class ContabilizarApli2 extends Contabilizar{
    /**
    ...
    public void contabilizarConMesYProfesor(ProfesorBean profesor, int mes){
        ...
        System.out.println("listaFichajes.size()="+listaFichajes.size());
        ...
        /**
         * Contabilizamos las horas lectivas (Terapia)
         */
        ArrayList<FichaBean> listaFichasLectivas=UtilsContabilizar.getHorarioCompacto(profesor, "T");
        int segundosLectivos=contabilizaHorasLectivasOCmplementarias(listaFichajesRecuento, listaFichasLectivas, profesor,"T", mes);
        
        /**
         * Contabilizar horas complementarias (Despacho)
         */
        ArrayList<FichaBean> listaFichasComplementarias=UtilsContabilizar.getHorarioCompacto(profesor, "D");
        int segundosComplementarios=contabilizaHorasLectivasOCmplementarias(listaFichajesRecuento, listaFichasComplementarias, profesor,"D", mes);
    ...
    private int contabilizaHorasLectivasOCmplementarias(ArrayList<FichajeRecuentoBean> listaFichajesRecuento, ArrayList<FichaBean> listaFichas, ProfesorBean profesor, String tipoHora, int mes) {
        System.out.println("ContabilizarApli2.contabilizaHorasLectivasOComplementarias");
